...
import "./global/otherPages/maintain/maintainWap.css";
...
class MaintainPage extends Component {
    ...
    serversOpen(e) {
        e.preventDefault();
        window.open(this.state["OnlineServiceUrl"], 'servers', 'directories=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,resizable=no');
        return false;
    }
