...
import PasswordAlert            from "../../global/Components/PasswordAlert/PasswordAlert"  // 导量用户更改密码弹窗
...
// ___________________________________________________________________ （ 新 ）
...
export default class Requirement extends BaseRequirement {
    constructor() {
        ...
        this.r("LootoPage", TurntablePage,{isHaveSurplus:false}); //isHaveSurplus是否存在剩余奖项
